...
@register_extractor
class AllWishExtractor(BaseExtractor):
    """Extractor for all-wish.me streaming site."""

    def __init__(self, http_client: HttpClient) -> None:
        super().__init__(http_client)
        self.base_url = "https://all-wish.me/"

    def match(self, url: str) -> bool:
        """Match URLs containing all-wish.me."""
        parsed = urlparse(url)
        return "all-wish.me" in parsed.netloc
