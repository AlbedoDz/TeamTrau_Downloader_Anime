...
title AllWish Downloader CLI - all-wish.me
cls
...
echo ============================================================
echo      ALL-WISH.ME - BATCH ANIME DOWNLOADER MODULE
echo ============================================================
echo.
echo Target Site : https://all-wish.me
echo Example URL : https://all-wish.me/watch/world-is-dancing-mof9c/ep-8
echo.
...
:PROMPT_URL
set "ANIME_URL="
set /p ANIME_URL="[1/7] Enter AllWish Watch/Anime URL: "
...
echo.
set "EPISODES="
set /p EPISODES="[2/7] Episode Range (e.g. all, 1-5, 8) [all]: "
...
echo.
echo ------------------------------------------------------------
echo  Starting AllWish Download...
echo  URL      : !ANIME_URL!
